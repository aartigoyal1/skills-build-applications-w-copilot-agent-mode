        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            ...
            <span className="navbar-text">
              <a className="btn btn-outline-light btn-sm" href="https://github.com/aartigoyal1/skills-build-applications-w-copilot-agent-mode" target="_blank" rel="noopener noreferrer">GitHub Repo</a>
            </span>
          </div>
        </div>
      </nav>
          ...
          <Route path="/" element={
            <div className="p-5 mb-4 bg-light rounded-3">
              <div className="container-fluid py-5">
                ...
                <a className="btn btn-primary btn-lg" href="/activities">View Activities</a>
              </div>
            </div>
          } />
        </Routes>
